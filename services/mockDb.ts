...
class MockDB {
  ...
  private seed() {
    ...
    // 2. Produtos (Added Images and Touch Flag)
    this.produtos = [
        { id: 1, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Cozinha', codigoInterno: '100', codigoBarras: '7890001', nome: 'X-Burger', preco: 25.00, custo: 10.00, unidadeMedida: 'UN', grupoProdutoId: 1, imagem: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=500&q=60' },
        { id: 2, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Bar', codigoInterno: '101', codigoBarras: '7890002', nome: 'Coca-Cola 350ml', preco: 6.00, custo: 3.00, unidadeMedida: 'UN', grupoProdutoId: 2, imagem: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&w=500&q=60' },
        { id: 3, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD1', codigoBarras: '', nome: 'Bacon Extra', preco: 5.00, custo: 2.00, unidadeMedida: 'UN', grupoProdutoId: 1 },
        { id: 10, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Cozinha', codigoInterno: 'COP180', codigoBarras: '', nome: 'Copo 180ml (2 Grátis)', preco: 13.00, custo: 4.00, unidadeMedida: 'UN', grupoProdutoId: 3, imagem: 'https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?auto=format&fit=crop&w=500&q=60' },
        { id: 11, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Cozinha', codigoInterno: 'COP300', codigoBarras: '', nome: 'Copo 300ml (3 Grátis)', preco: 18.00, custo: 6.00, unidadeMedida: 'UN', grupoProdutoId: 3, imagem: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?auto=format&fit=crop&w=500&q=60' },
        { id: 12, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Cozinha', codigoInterno: 'COP500', codigoBarras: '', nome: 'Copo 500ml (3 Grátis)', preco: 22.00, custo: 8.00, unidadeMedida: 'UN', grupoProdutoId: 3, imagem: 'https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?auto=format&fit=crop&w=500&q=60' },
        { id: 13, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Cozinha', codigoInterno: 'COP700', codigoBarras: '', nome: 'Copo 700ml (4 Grátis)', preco: 27.00, custo: 10.00, unidadeMedida: 'UN', grupoProdutoId: 3, imagem: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?auto=format&fit=crop&w=500&q=60' },
        { id: 14, ativo: true, disponivelTouch: true, tipo: 'Principal', setor: 'Cozinha', codigoInterno: 'BARCA500', codigoBarras: '', nome: 'Barca 500ml (6 Grátis)', preco: 32.00, custo: 12.00, unidadeMedida: 'UN', grupoProdutoId: 3, imagem: 'https://images.unsplash.com/photo-1553882951-9c3dab4a50cb?auto=format&fit=crop&w=500&q=60' },
        { id: 50, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-LEITE', codigoBarras: '', nome: 'Leite em Pó', preco: 3.00, custo: 0.50, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 51, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-COND', codigoBarras: '', nome: 'Leite Condensado', preco: 3.00, custo: 0.60, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 52, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-GRAN', codigoBarras: '', nome: 'Granola', preco: 3.00, custo: 0.40, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 53, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-PAC', codigoBarras: '', nome: 'Paçoca', preco: 3.00, custo: 0.30, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 54, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-BAN', codigoBarras: '', nome: 'Banana', preco: 3.00, custo: 0.30, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 55, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-MOR', codigoBarras: '', nome: 'Morango', preco: 3.00, custo: 0.80, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 56, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'ADD-CHOC', codigoBarras: '', nome: 'Chocoball', preco: 3.00, custo: 0.50, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 80, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'PREM-NUT', codigoBarras: '', nome: 'Nutella (Creme Avelã)', preco: 5.00, custo: 2.00, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 81, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'PREM-NIN', codigoBarras: '', nome: 'Creme de Ninho', preco: 5.00, custo: 1.80, unidadeMedida: 'POR', grupoProdutoId: 4 },
        { id: 82, ativo: true, disponivelTouch: false, tipo: 'Complemento', setor: 'Cozinha', codigoInterno: 'PREM-OVOM', codigoBarras: '', nome: 'Creme de Ovomaltine', preco: 5.00, custo: 1.90, unidadeMedida: 'POR', grupoProdutoId: 4 },
    ];
