    ...
    if (confirm("Confirma o fechamento do caixa?")) {
        try {
             ...
             const closedSessionForPrint: SessaoCaixa = {
                 ...
                 conferenciaOperador: closingValues,
    ...
    const handleConsolidate = () => {
        ...
        if (confirm("Confirmar a consolidação deste caixa? Esta ação é irreversível.")) {
            try {
                ...
                // Get updated session for print
                const updatedSession = { 
                    ...selectedSession, 
                    conferenciaAuditoria: auditValues,
                    quebraDeCaixa: (auditValues.dinheiro + auditValues.cartaoCredito + auditValues.cartaoDebito + auditValues.pix + auditValues.voucher + auditValues.outros) - (selectedSession.saldoFinalSistema || 0),
